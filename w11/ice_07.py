...
Build and process a compound list that tracks student names, their homework
average, and their exam score.  Reinforces:
...
def main():
    ...
    while keep_going == True:
        name = input("Enter the student's name. Enter blank to finish: ")
        if name == "":
            keep_going = False
        else:
            homework = float(input("Enter the student's homework average: "))
            exam = float(input("Enter the student's exam score: "))
            gradebook.append([name, homework, exam])
