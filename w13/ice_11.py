...
def main():
    ...
    doubled_numbers = list(map(lambda x: x*2, numbers_1))
    ...
    # TODO: Replace the ... with your code
    uppercase_words = list(map(str.upper, words))    # hint: list(map(..., ...)) 
    ...
    # Given a list of numbers, use map and lambda to create a new list of 
    # True or False, indicating whether each number is even.
    ...
    # Given a list of temperatures in Celsius, use map and lambda to convert 
    # each temperature to Fahrenheit.
    ...
    # TODO: Replace the ... with your code    
    temperatures_fahrenheit = list(map(lambda cel: (cel * (9/5)) + 32, temperatures_celsius))
    print("Exercise 6 - Temperatures in Fahrenheit:\n", temperatures_fahrenheit)



    ##### Exercise 7: Extract the Length of each String #####
    # Given a list of strings, use map and lambda to create a list of the 
    ...
    # Given two lists of numbers, use map and lambda to create a new list 
    # where each element is the sum of the corresponding elements from the 
    # two lists.
